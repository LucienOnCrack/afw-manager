	...
	var methods = {
		init : function(options) {
			this.each(function() {
				...
				if (parseInt($verticalBar.css('width')) == 0 || $verticalBar.css('width') == 'auto') $verticalBar.css({'width': 8, 'border-radius': 5, 'cursor': 'default' });
				...
				if (parseInt($horizontalBar.css('height')) == 0 || $horizontalBar.css('height') == 'auto') $horizontalBar.css({ 'height': 8, 'border-radius': 5, 'cursor': 'default' });
